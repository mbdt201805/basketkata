...
namespace BasketKata.Tests
{
    ...
    public class WhenITotalTheBasketThen
    {
        ...
        [Test]
        public void TheTotalShouldBe6Pounds20_GivenTheBasketHas4ButterAnd4Bread()
        {
            var basket = new Basket();
            basket.Add(Butter);
            basket.Add(Butter);
            ...
            total.ShouldBe(new Gbp(6.20m));
        }

        [Test]
        public void TheTotalShouldBe3Pounds45_GivenTheBasketHas4Milk()
        {
            var basket = new Basket();
            basket.Add(Milk);
            basket.Add(Milk);
